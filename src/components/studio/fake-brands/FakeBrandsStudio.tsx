...
import {
  ApplyKitToProjectButton,
  TemplatePresetCard,
} from "@/components/studio/fake-brands/TemplatePresetCard";
...
export function FakeBrandsStudio() {
      ...
      <aside className="flex w-56 shrink-0 flex-col border-r border-border bg-card/40">
        <div className="border-b border-border px-4 py-3">
          ...
          <p className="text-[10px] leading-snug text-muted-foreground">
            Internal studio surface · demo data only
          </p>
        </div>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        ...
        >
          <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            <ApplyKitToProjectButton kit={kit} />
          </div>
        </header>

        <div className="space-y-10 px-6 py-8">
          {/* Motion lab — featured previews */}
          <section id="motion-lab" className="scroll-mt-4">
            <div className="mb-4 flex items-end justify-between gap-4">
              <div>
                <h3 className="text-sm font-semibold">Motion lab</h3>
                <p className="mt-0.5 text-xs text-muted-foreground">
                  CSS placeholders driven by kit easing, timing, colors, and effects.
                </p>
              </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_320px]">
            ...
            <section id="templates" className="scroll-mt-4 space-y-3 lg:sticky lg:top-28 lg:self-start">
              ...
              <p className="text-[10px] text-muted-foreground">
                Stub actions wired to brand-motion-kit integration hooks.
              </p>
